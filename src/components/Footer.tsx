        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-2">
                <h3 className="text-lg font-bold leading-tight">Renewable</h3>
                <h4 className="text-base leading-tight">Meet 2026</h4>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              The premier global conference for renewable energy leaders and innovators.
            </p>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mb-2">
                <a href="mailto:info@renewablemeet2026.org" className="hover:text-white transition-colors">info@renewablemeet2026.org</a>
              </p>
              <p>
